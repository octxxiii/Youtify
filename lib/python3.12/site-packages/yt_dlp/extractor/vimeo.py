...
class VimeoBaseInfoExtractor(InfoExtractor):
    ...
    def _real_initialize(self):
        if self._LOGIN_REQUIRED and not self._get_cookies("https://vimeo.com").get(
            "vuid"
        ):
    ...
    def _parse_config(self, config, video_id):
        ...
        chapters = [
            ...
            for current_chapter, next_chapter in zip(
                chapter_data, chapter_data[1:] + [{"timecode": duration}]
            )
        ]
            ...
            chapters[:0] = [
                {
                    "title": "<Untitled>",
                    "start_time": 0,
                    "end_time": chapters[0]["start_time"],
                }
            ]
