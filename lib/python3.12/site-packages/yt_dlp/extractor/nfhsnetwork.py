    ...
    def _real_extract(self, url):
        ...
        uploaderPrefix = (
            ...
            if pubType == "school"
                ...
                "associations"
                if "association" in pubType
                else (
                    "affiliates"
                    if (pubType == "publisher" or pubType == "affiliate")
                    else "schools"
                )
            )
        )
        uploaderPage = "https://www.nfhsnetwork.com/%s/%s" % (
            uploaderPrefix,
            publisher.get("slug"),
        )
        ...
        m3u8_url = self._download_json(
            "https://cfunity.nfhsnetwork.com/v2/%s/%s/url" % (video_type, key), video_id
        ).get("video_url")
