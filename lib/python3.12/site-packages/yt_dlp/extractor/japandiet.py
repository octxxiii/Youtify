...
class SangiinInstructionIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        raise ExtractorError(
            "Copy the link from the botton below the video description or player, and use the link to download. If there are no button in the frame, get the URL of the frame showing the video.",
            expected=True,
        )
