    ...
    def _real_extract(self, url):
        ...
        if video_id == "None":
            ...
            video_id = self._html_search_regex(
                r'data-asset-id="([^"]+)"', webpage, "video_id"
            )
        json = self._download_json(
            "https://wcps.t-online.de/cvss/magentamusic/vodplayer/v3/player/58935/%s/Main%%20Movie"
            % video_id,
            video_id,
        )
        xml_url = json["content"]["feature"]["representations"][0]["contentPackages"][
            0
        ]["media"]["href"]
