    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "timestamp": unified_timestamp(
                traverse_obj(movie_store, "createdAt", expected_type=compat_str)
            ),
            "uploader": traverse_obj(
                movie_store, ("channel", "name"), expected_type=compat_str
            ),
            "uploader_id": traverse_obj(
                movie_store, ("channel", "id"), expected_type=compat_str
            ),
