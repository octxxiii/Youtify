...
class TuneInBaseIE(InfoExtractor):
    ...
    def _extract_metadata(self, webpage, content_id):
        return self._search_json(
            r"window.INITIAL_STATE=", webpage, "hydration", content_id, fatal=False
        )
...
class TuneInStationIE(TuneInBaseIE):
    _VALID_URL = (
        TuneInBaseIE._VALID_URL_BASE + r"(?:/radio/[^?#]+-|/embed/player/)(?P<id>s\d+)"
    )
    _EMBED_REGEX = [
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "timestamp": parse_iso8601(
                traverse_obj(
                    metadata, ("profiles", station_id, "actions", "play", "publishTime")
                )
            ),
...
class TuneInPodcastIE(TuneInBaseIE):
    ...
    _TESTS = [
        ...
        {"url": "https://tunein.com/embed/player/p191660/", "only_matching": True},
        {
...
class TuneInPodcastEpisodeIE(TuneInBaseIE):
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "timestamp": parse_iso8601(
                traverse_obj(
                    metadata, ("profiles", episode_id, "actions", "play", "publishTime")
                )
            ),
