...
class MotorTrendOnDemandIE(DiscoveryPlusBaseIE):
    _VALID_URL = (
        r"https?://(?:www\.)?motortrend(?:ondemand\.com|\.com/plus)/detail"
        + DPlayBaseIE._PATH_REGEX
    )
    _TESTS = [
        {
...
class DiscoveryPlusIE(DiscoveryPlusBaseIE):
    _VALID_URL = (
        r"https?://(?:www\.)?discoveryplus\.com/(?!it/)(?:\w{2}/)?video"
        + DPlayBaseIE._PATH_REGEX
    )
    _TESTS = [
        {
...
class DiscoveryPlusItalyIE(DiscoveryPlusBaseIE):
    _VALID_URL = (
        r"https?://(?:www\.)?discoveryplus\.com/it/video" + DPlayBaseIE._PATH_REGEX
    )
    _TESTS = [
        {
