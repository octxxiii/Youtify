...
class ORFTVthekIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        {
            "url": "https://tvthek.orf.at/profile/ZIB-2/1211/ZIB-2/14121079/Umfrage-Welches-Tier-ist-Sebastian-Kurz/15083150",
            "info_dict": {"id": "14121079", "playlist_count": 1},
            "playlist": [
                {
                    "info_dict": {
                        "id": "15083150",
    ...
    def _pagefunc(self, url, data_jsb, n, *, image=None):
        ...
        for fd in sd["sources"]:
            ...
            format_id = join_nonempty(
                "delivery", "quality", "quality_string", from_dict=fd
            )
            ...
            if ext == "m3u8":
                m3u8_formats = self._extract_m3u8_formats(
                    ...
                    m3u8_id=format_id,
                    fatal=False,
                    note=f"Downloading {format_id} m3u8 manifest",
                )
        ...
        yield {
            "id": video_id,
            "title": title,
            "webpage_url": smuggle_url(
                f"{url}/part/{video_id}", {"force_noplaylist": True}
            ),
            "formats": formats,
            "subtitles": subtitles,
    ...
    def _real_extract(self, url):
        ...
        playlist_id, video_id, base_url = self._match_valid_url(url).group(
            "id", "vid", "url"
        )
