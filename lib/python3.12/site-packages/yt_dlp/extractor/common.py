...
class InfoExtractor:
    ...
    def _og_regexes(prop):
        ...
        property_re = (
            r'(?:name|property)=(?:\'og%(sep)s%(prop)s\'|"og%(sep)s%(prop)s"|\s*og%(sep)s%(prop)s\b)'
    ...
    def _extract_m3u8_formats_and_subtitles(
        ...
        res = self._download_webpage_handle(
            ...
            errnote=(
                "Failed to download m3u8 information" if errnote is None else errnote
            ),
            fatal=fatal,
            data=data,
            headers=headers,
            ...
            formats = [
                {
                    ...
                    "url": m3u8_url
                    or encode_data_uri(
                        m3u8_doc.encode("utf-8"), "application/x-mpegurl"
                    ),
                    "ext": ext,
