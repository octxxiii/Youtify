...
class TumblrIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if self._ACCESS_TOKEN:
            post_json = (
                traverse_obj(
                    ...
                    ("response", "timeline", "elements", 0),
                )
                or {}
            )
        content_json = (
            traverse_obj(post_json, ("trail", 0, "content"), ("content")) or []
        )
        video_json = next(
        ...
        formats = formats or [
            {
                ...
                "width": int_or_none(
                    ...
                    or self._og_search_property("video:width", webpage, default=None)
                ),
                "height": int_or_none(
                    media_json.get("height")
                    or self._og_search_property("video:height", webpage, default=None)
                ),
            }
        ]
        ...
        return {
            ...
            "thumbnail": (
                traverse_obj(video_json, ("poster", 0, "url"))
