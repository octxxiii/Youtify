...
class YoutubeWebArchiveIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        {"url": "ytarchive:BaW_jenozKc:20050214000000", "only_matching": True},
        {"url": "ytarchive:BaW_jenozKc", "only_matching": True},
    ]
    ...
    _YT_ALL_THUMB_SERVERS = orderedSet(
        ...
        + [
            "img.youtube.com",
            *[f'{c}{n or ""}.ytimg.com' for c in ("i", "s") for n in (*range(0, 5), 9)],
        ]
    )
        ...
        for retry in retry_manager:
            try:
                urlh = self._request_webpage(
                    HEADRequest(
                        "https://web.archive.org/web/2oe_/http://wayback-fakeurl.archive.org/yt/%s"
                        % video_id
                    ),
                    video_id,
