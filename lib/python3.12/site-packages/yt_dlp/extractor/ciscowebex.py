...
class CiscoWebexIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        stream, urlh = self._download_json_handle(
            "https://%s.webex.com/webappng/api/v1/recordings/%s/stream"
            % (subdomain, video_id),
            video_id,
            headers=headers,
        ...
        return {
            ...
            "webpage_url": "https://%s.webex.com/recordingservice/sites/%s/recording/playback/%s"
            % (subdomain, siteurl, video_id),
            "formats": formats,
        }
