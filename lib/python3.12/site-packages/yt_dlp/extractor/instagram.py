...
class InstagramBaseIE(InfoExtractor):
    ...
    def _perform_login(self, username, password):
        ...
        login_webpage = self._download_webpage(
            self._LOGIN_URL,
            None,
            note="Downloading login webpage",
            errnote="Failed to download login webpage",
        )
        ...
        if not login.get("authenticated"):
            if login.get("message"):
                ...
                raise ExtractorError(
                    "Unable to login: Sorry, your password was incorrect. Please double-check your password.",
                    expected=True,
                )
            elif login.get("user") is False:
                raise ExtractorError(
                    "Unable to login: The username you entered doesn't belong to an account. Please check your username and try again.",
                    expected=True,
                )
    ...
    def _extract_product(self, product_info):
        ...
        return {**info_dict, **self._extract_product_media(product_info)}
...
class InstagramStoryIE(InstagramBaseIE):
    ...
    def _real_extract(self, url):
        ...
        user_info = self._search_json(
            r'"user":', story_info, "user info", story_id, fatal=False
        )
        if not user_info:
        ...
        story_info_url = (
            user_id if username != "highlights" else f"highlight:{story_id}"
        )
