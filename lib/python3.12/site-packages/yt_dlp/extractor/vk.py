...
class VKUserVideosIE(VKBaseIE):
    ...
    _TESTS = [
        ...
        },
        {
            ...
            "info_dict": {"id": "-174476437_playlist_2", "title": "Анонсы"},
    ...
    def _real_extract(self, url):
        ...
        if u_id.startswith("@"):
            page_id = self._search_regex(
                r'data-owner-id\s?=\s?"([^"]+)"', webpage, "page_id"
            )
        elif "_" in u_id:
...
class VKPlayIE(VKPlayBaseIE):
    _VALID_URL = (
        r"https?://vkplay\.live/(?P<username>[^/#?]+)/record/(?P<id>[a-f0-9-]+)"
    )
    _TESTS = [
        {
