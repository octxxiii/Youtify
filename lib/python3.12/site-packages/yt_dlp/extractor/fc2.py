...
class FC2IE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        vidplaylist = self._download_json(
            "https://video.fc2.com/api/v3/videoplaylist/%s?sh=1&fs=0" % video_id,
            video_id,
...
class FC2LiveIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        webpage = self._download_webpage(
            "https://live.fc2.com/%s/" % video_id, video_id
        )
        ...
        member_api = self._download_json(
            ...
            data=urlencode_postdata(
                {"channel": "1", "profile": "1", "user": "1", "streamid": video_id}
            ),
        ...
        while True:
            ...
            if data.get("name") == "_response_" and data.get("id") == 1:
                ...
                break
            self.write_debug(
                "Server said: %s%s" % (recv[:100], "..." if len(recv) > 100 else "")
            )
