    ...
    def _perform_login(self, username, password):
        ...
        # Mobile number as username is not supported
            ...
            check_username = self._download_json(
                ...
                None,
                data=json.dumps(
                    {"type": "email", "email": username}, separators=(",", ":")
                ).encode(),
                headers={
                    **self._API_HEADERS,
            ...
            auth_token = traverse_obj(
                self._download_json(
                    "https://userauth.voot.com/usersV3/v3/login",
                    None,
                    data=json.dumps(
                        {
                            "type": "traditional",
...
class VootIE(VootBaseIE):
    ...
    def _real_extract(self, url):
        ...
        media_info = self._download_json(
            "https://psapi.voot.com/jio/voot/v1/voot-web/content/query/asset-details",
            video_id,
            query={"ids": f"include:{video_id}", "responseType": "common"},
            headers={"accesstoken": self._TOKEN},
        )

        try:
            m3u8_url = self._download_json(
                "https://vootapi.media.jio.com/playback/v1/playbackrights",
                video_id,
