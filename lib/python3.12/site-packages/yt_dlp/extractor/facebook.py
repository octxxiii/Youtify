...
class FacebookIE(InfoExtractor):
    ...
    def _extract_from_url(self, url, video_id):
        ...
        def extract_metadata(webpage):
            ...
            is_video_broadcast = get_first(
                subs_data, "is_video_broadcast", expected_type=bool
            )
            captions = get_first(
                subs_data, "video_available_captions_locales", "captions_url"
            )
            ...
            for caption in traverse_obj(
                ...
                subs = {
                    ...
                    "name": format_field(
                        caption, "localized_country", f"{lang} (%s)", default=lang
                    ),
                }
                ...
                def parse_graphql_video(video):
                    ...
                    for key, format_id in (
                        ...
                        if determine_ext(playable_url) == "mpd":
                            formats.extend(
                                self._extract_mpd_formats(playable_url, video_id)
                            )
                        else:
                            formats.append(
                                {
