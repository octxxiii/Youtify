...
class CPACIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "thumbnail": urljoin(
                url, str_or_none(content["details"].get("image_%s_s" % (url_lang,)))
            ),
    ...
    def _real_extract(self, url):
        ...
        return self.playlist_result(
            ...
            playlist_title=try_get(
                content, lambda x: x["page"]["program"]["title_%s_t" % (url_lang,)]
            )
            or video_id.split("=")[-1],
            playlist_description=try_get(
                content,
                lambda x: x["page"]["program"]["description_%s_t" % (url_lang,)],
            ),
        )
