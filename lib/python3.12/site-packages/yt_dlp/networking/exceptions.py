...
class _CompatHTTPError(urllib.error.HTTPError, HTTPError):
    ...
    def __init__(self, http_error: HTTPError):
        ...
        HTTPError.__init__(
            self, http_error.response, redirect_loop=http_error.redirect_loop
        )
    ...
    def headers(self):
        deprecation_warning(
            "HTTPError.headers is deprecated, use HTTPError.response.headers instead"
        )
    ...
    def info(self):
        deprecation_warning(
            "HTTPError.info() is deprecated, use HTTPError.response.headers instead"
        )
        return self.response.headers

    def getcode(self):
        deprecation_warning(
            "HTTPError.getcode is deprecated, use HTTPError.status instead"
        )
        return self.status

    def geturl(self):
        deprecation_warning(
            "HTTPError.geturl is deprecated, use HTTPError.response.url instead"
        )
    ...
    def code(self):
        deprecation_warning(
            "HTTPError.code is deprecated, use HTTPError.status instead"
        )
        return self.status
    ...
    def url(self):
        deprecation_warning(
            "HTTPError.url is deprecated, use HTTPError.response.url instead"
        )
        return self.response.url
    ...
    def hdrs(self):
        deprecation_warning(
            "HTTPError.hdrs is deprecated, use HTTPError.response.headers instead"
        )
        return self.response.headers
    ...
    def filename(self):
        deprecation_warning(
            "HTTPError.filename is deprecated, use HTTPError.response.url instead"
        )
        return self.response.url
    ...
    def __getattr__(self, name):
        ...
        if name in passthrough_warnings:
            deprecation_warning(
                f"HTTPError.{name} is deprecated, use HTTPError.{passthrough_warnings[name]} instead"
            )
