...
class QMacPasteboardMime(PyQt5.sipsimplewrapper):
    ...
    def convertFromMime(
        self, mime: typing.Optional[str], data: typing.Any, flav: typing.Optional[str]
    ) -> typing.List[QtCore.QByteArray]: ...
    def convertToMime(
        self,
        mime: typing.Optional[str],
        data: typing.Iterable[typing.Union[QtCore.QByteArray, bytes, bytearray]],
        flav: typing.Optional[str],
    ) -> typing.Any: ...
    def flavorFor(self, mime: typing.Optional[str]) -> str: ...
    def mimeFor(self, flav: typing.Optional[str]) -> str: ...
    def canConvert(
        self, mime: typing.Optional[str], flav: typing.Optional[str]
    ) -> bool: ...
...
class QMacToolBar(QtCore.QObject):
    ...
    def setAllowedItems(
        self, allowedItems: typing.Iterable["QMacToolBarItem"]
    ) -> None: ...
    ...
    ) -> typing.Optional["QMacToolBarItem"]: ...
    def addItem(
        self, icon: QtGui.QIcon, text: typing.Optional[str]
    ) -> typing.Optional["QMacToolBarItem"]: ...
